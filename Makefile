...
UNREALROOTPATH = /home/drmcfree/Applications/UnrealEngine
GAMEPROJECTFILE =/home/drmcfree/Projects/Unreal Projects/MyFirst/MyFirst.uproject
...
TARGETS = \
	...
	UnrealServer \
	MyFirst-Linux-Debug  \
	MyFirst-Linux-DebugGame  \
	MyFirst-Linux-Test  \
	MyFirst-Linux-Shipping  \
	MyFirst \
	MyFirstEditor-Linux-Debug  \
	MyFirstEditor-Linux-DebugGame  \
	MyFirstEditor-Linux-Test  \
	MyFirstEditor-Linux-Shipping  \
	MyFirstEditor\
	configure
...
MyFirst-Linux-Debug:
	 $(PROJECTBUILD) MyFirst Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyFirst-Linux-DebugGame:
	 $(PROJECTBUILD) MyFirst Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyFirst-Linux-Test:
	 $(PROJECTBUILD) MyFirst Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyFirst-Linux-Shipping:
	 $(PROJECTBUILD) MyFirst Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyFirst:
	 $(PROJECTBUILD) MyFirst Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyFirstEditor-Linux-Debug:
	 $(PROJECTBUILD) MyFirstEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyFirstEditor-Linux-DebugGame:
	 $(PROJECTBUILD) MyFirstEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyFirstEditor-Linux-Test:
	 $(PROJECTBUILD) MyFirstEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyFirstEditor-Linux-Shipping:
	 $(PROJECTBUILD) MyFirstEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyFirstEditor:
	 $(PROJECTBUILD) MyFirstEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
